...
setup(
    ...
    install_requires=["ricxappframe==3.2.2", "joblib>=0.3.2", "statsmodels>=0.11.1", "mdclogpy<=1.1.1", "influxdb", "pandas==1.5.3", "numpy==1.26.0", "influxdb_client", "scikit-learn", "schedule", "joblib"],
